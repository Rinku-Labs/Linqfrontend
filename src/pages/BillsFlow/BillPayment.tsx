...
export default function BillPayment() {
    ...
    const handleSuiPayment = async () => {
        ...
        try {
            const totalBalance = await getTotalBalance(suiGrpcClient, currentSuiAccount.address, SUI_USDC_COIN_TYPE);
            ...
            if (!tx) {
                ...
                const coins = await getAllCoins(suiGrpcClient, currentSuiAccount.address, SUI_USDC_COIN_TYPE);

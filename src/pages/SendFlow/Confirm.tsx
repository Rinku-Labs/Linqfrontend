...
export default function Confirm() {
    ...
    const handleSuiPayment = async (walletAddress: string, orderId: string) => {
        ...
        try {
            ...
            const totalBalance = await getTotalBalance(suiGrpcClient, currentAccount.address, SUI_USDC_COIN_TYPE);
            ...
            if (!tx) {
                ...
                const coins = await getAllCoins(suiGrpcClient, currentAccount.address, SUI_USDC_COIN_TYPE);
